...
void Inspector::CreateComponentUI()
{
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::RAYCASTER2D] = new RayCaster2DUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::RAYCASTER2D]->SetName("RayCaster2DUI");
	m_arrComUI[(UINT)COMPONENT_TYPE::RAYCASTER2D]->SetChildSize(ImVec2(0.f, 100.f));
	AddChild(m_arrComUI[(UINT)COMPONENT_TYPE::RAYCASTER2D]);
