...
void CCamera::Render()
{
	...
	CLevel* pLevel = CLevelMgr::GetInst()->GetCurrentLevel();
	if (LEVEL_STATE::STOP == CLevelMgr::GetInst()->GetCurrentLevel()->GetState())
	{
		for (int i = 0; i < MAX_LAYER; i++)
		{
			for (int j = 0; j < pLevel->GetLayer(i)->GetObjects().size(); j++)
			{
				switch (i)
				{
				case (UINT)LAYER_NAME::NOT_DECIDED:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(1.f, 0.f, 0.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::MONSTER:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(0.f, 0.f, 1.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::SPRITE:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(0.f, 1.f, 0.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::PLAYER:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(1.f, 1.f, 0.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::MONSTER_BULLET:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(1.f, 0.f, 1.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::PLAYER_BULLET:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(0.5f, 0.5f, 0.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::PICKUP:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(1.f, 0.5f, 1.f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::RAYCASTRENDER:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(1.f, 0.4f, 0.7f, 1.f), 0.f, false);
					break;
				case (UINT)LAYER_NAME::UI:
					DrawDebugCircle(pLevel->GetLayer(i)->GetObjects()[j]->Transform()->GetWorldPos(), 10.f, Vec4(1.f, 0.45f, 0.77f, 1.f), 0.f, false);
					break;
				default:
					break;
				}
	...
	CRenderMgr::GetInst()->SortMiscObjects();
	CRenderMgr::GetInst()->RenderMisc();
